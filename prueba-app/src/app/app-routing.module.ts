...
const routes: Routes = [
  ...
  { path: 'Editar_producto',loadChildren: () => import('./components/panel_admin/products/edit-product/edit-product.module').then(m => m.EditProductModule) },
  ...
  { path: 'Editar_categoria',loadChildren: () => import('./components/panel_admin/categories/edit-category/edit-category.module').then(m => m.EditCategoryModule) },
